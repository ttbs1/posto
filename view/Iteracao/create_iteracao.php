            ...
            <div clas="span10 offset1">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="form-horizontal needs-validation" novalidate action="create_iteracao.php" method="post">
                            ...
                            <div id="tarefa">
                                ...
                                <div class="form-group col-md-8">
                                    ...
                                    <textarea maxlength="450" class="form-control" rows="4" name="descricao" id="descricao" required></textarea>
        ...
        <div class="modal fade" id="confirmModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group col-md-8">
                            A iteração foi cadastrada com sucesso!
                    </div>
