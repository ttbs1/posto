...
session_start(); 
if((substr_compare($_SESSION['permissao']['projeto'], '0', 3, 1)) == 0) {
...
if(!empty($_POST))
{
    ...
    $try = $projetoControle->deleteProjeto($id);
    ...
    <body>
        <div class="container">
            ...
            <div class="span10 offset1">
                <div class="row">
                    <h3 class="well" id="plabel">Excluir Projeto</h3>
                </div>
                <form class="form-horizontal" action="delete_projeto.php" method="post">
                    <input type="hidden" name="id" value="<?php echo $id;?>" />
                    <div class="alert alert-danger"> Deseja confirmar a exclusão do projeto?
                    </div>
                    <div class="form actions">
                        <button type="submit" class="btn btn-danger">Sim</button>
                        <a href="detail_projeto.php?id=<?php echo $id;?>" type="btn" class="btn btn-default">Não</a>
                    </div>
                </form>
            </div>
        </div>
